...
import { getAllDocumentacionDocente, createDocumento, deleteDocumento } from '../services/documentacionDocenteService.js'

export function useDocumentacionDocente(personaId = null) {
    ...
    const fetchDocumentacion = async (filters = {}) => {
        ...
        try {
            ...
            if (personaId) {
                mergedFilters.id_persona = personaId
            }
            const data = await getAllDocumentacionDocente(mergedFilters)
