import {
  script as script13
} from "./chunk-57BM6VXT.js";
import {
  script4 as script12
} from "./chunk-7XR367PK.js";
import {
  script as script14
} from "./chunk-WTKGXYJW.js";
import {
  script as script15
} from "./chunk-QGGDQOTL.js";
import {
  script as script11
} from "./chunk-PCPL4MEB.js";
import {
  script as script16
} from "./chunk-R244QFUH.js";
import "./chunk-4EP5TFY2.js";
import {
  script as script17,
  script2 as script18
} from "./chunk-S43QLAYL.js";
import "./chunk-2ESCNKNQ.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus,
  _default,
  getVNodeProp
} from "./chunk-BOYDGQVC.js";
import {
  script as script8
} from "./chunk-UBZGXYV3.js";
import {
  script as script6
} from "./chunk-QTTQ6QZ6.js";
import {
  script as script7
} from "./chunk-3OBJRAXV.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-DUKNHW5U.js";
import {
  FocusTrap
} from "./chunk-M5MCD42P.js";
import {
  script as script9
} from "./chunk-XAHI5QDI.js";
import {
  script as script10
} from "./chunk-4DO3RNNA.js";
import {
  script as script4,
  script2 as script5
} from "./chunk-O3R5Q45E.js";
import {
  script as script3
} from "./chunk-FIG5Z7BJ.js";
import {
  Ripple
} from "./chunk-RXYTWR2E.js";
import {
  script as script2
} from "./chunk-FSVRNE3H.js";
import "./chunk-3LX3BLXE.js";
import {
  script
} from "./chunk-L2WORVH3.js";
import {
  BaseStyle
} from "./chunk-DOJUPKGL.js";
import {
  C,
  C2,
  D,
...
function _slicedToArray2(r, e) {
  return _arrayWithHoles2(r) || _iterableToArrayLimit2(r, e) || _unsupportedIterableToArray15(r, e) || _nonIterableRest2();
}
...
var script34 = {
  ...
  data: function data12() {
    return {
      ...
      d_multiSortMeta: this.multiSortMeta ? _toConsumableArray14(this.multiSortMeta) : [],
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data13 = _toConsumableArray14(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray14(this.d_multiSortMeta));
        }
      }
      var data13 = _toConsumableArray14(value);
      data13.sort(function(data1, data22) {
    ...
    addMultiSortField: function addMultiSortField(field2) {
      ...
      this.d_multiSortMeta = _toConsumableArray14(this.d_multiSortMeta);
    },
      ...
      for (var i = 0; i < data13.length; i++) {
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](c(data13[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray14(_selection2), [rowData]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray14(this.selection), [rowData]) : [rowData];
    ...
    onSpaceKey: function onSpaceKey(event, rowData, rowIndex2, slotProps) {
      ...
      if (event.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = C(this.selection[0], data13);
          lastSelectedRowIndex = C(this.selection[this.selection.length - 1], data13);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = C(this.selection, data13);
        }
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray14(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray14(_selection5), [rowData]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked2) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray14(this.frozenValue), _toConsumableArray14(this.processedData)) : this.processedData;
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            ...
            this.d_selectionKeys[String(c(data13, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this.d_editingRowKeys[String(c(data13, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    generateCSV: function generateCSV(options, data13) {
      ...
      if (!data13) {
        ...
        else if (this.frozenValue) data13 = data13 ? [].concat(_toConsumableArray14(this.frozenValue), _toConsumableArray14(data13)) : this.frozenValue;
      }
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(e) {
      ...
      if (this.draggedColumnElement) {
        ...
        if (allowDrop) {
          ...
          var reorderedWidths = [].concat(_toConsumableArray14(remainingItems.slice(0, dropColIndex)), [movedItem], _toConsumableArray14(remainingItems.slice(dropColIndex)));
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray14(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray14(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event = e.originalEvent;
      var data13 = e.data;
      var groupFieldValue = c(data13, this.groupRowsBy);
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray14(this.expandedRowGroups) : [];
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray14(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray14(this.editingRows);
  ...
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray14(cols.filter(function(item) {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray14(this.frozenValue), _toConsumableArray14(this.processedData)) : this.processedData;
