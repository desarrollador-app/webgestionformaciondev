...
const tiposDocumento = ref([
    { label: 'Control de asistencia', value: 'Control de asistencia' },
    { label: 'Recibí de material', value: 'Recibí de material' },
    { label: 'Recibí de diploma', value: 'Recibí de diploma' },
    { label: 'Cuestionario de calidad', value: 'Cuestionario de calidad' },
    { label: 'Presupuesto', value: 'Presupuesto' },
    { label: 'Envío presupuesto', value: 'Envío presupuesto' },
    { label: 'Aceptación presupuesto', value: 'Aceptación presupuesto' },
