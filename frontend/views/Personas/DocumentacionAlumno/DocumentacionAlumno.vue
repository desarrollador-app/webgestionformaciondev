<template>
    <ReusableArticle 
        title="Documentación del alumno"
    >
        ...
        <ReusableDialog 
            ...
            :form-component="DocumentacionAlumnoForm"
            :form-data="formData"
...
import DocumentacionAlumnoForm from './DocumentacionAlumnoForm.vue'
import { useDocumentacionAlumno } from '@/composables/useDocumentacionAlumno.js'
import { getSignedUrl } from '@/services/documentacionAlumnoService.js'
...
const { documentacion, loading, error, fetchDocumentacion, addDocumento, removeDocumento } = useDocumentacionAlumno(props.personaId)
