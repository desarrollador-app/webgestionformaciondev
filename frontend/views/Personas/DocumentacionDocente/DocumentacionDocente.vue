<template>
    <ReusableArticle 
        title="Documentación del docente"
    >
        ...
        <ReusableDialog 
            ...
            :form-component="DocumentacionDocenteForm"
            :form-data="formData"
...
import DocumentacionDocenteForm from './DocumentacionDocenteForm.vue'
import { useDocumentacionDocente } from '@/composables/useDocumentacionDocente.js'
import { getSignedUrl } from '@/services/documentacionDocenteService.js'
...
const { documentacion, loading, error, fetchDocumentacion, addDocumento, removeDocumento } = useDocumentacionDocente(props.personaId)
