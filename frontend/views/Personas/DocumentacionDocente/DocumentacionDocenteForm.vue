...
const tiposDocumento = ref([
    ...
    { label: 'Habilitación', value: 'Habilitación' },
    { label: 'Competencia docente', value: 'Competencia docente' },
    { label: 'Teleformación', value: 'Teleformación' },
    { label: 'Doc. seguridad y confidencialidad', value: 'Doc. seguridad y confidencialidad' },
